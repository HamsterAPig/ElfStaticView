...
[[nodiscard]] std::optional<std::uint64_t> apply_bias_to_absolute(const ExpandedNode& node,
                                                                  std::int64_t bias);
[[nodiscard]] std::optional<std::int64_t> apply_bias_to_relative(const ExpandedNode& node,
                                                                 std::int64_t bias);
