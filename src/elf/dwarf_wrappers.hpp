...
private:
    ...
    [[nodiscard]] static Dwarf_Debug open_debug(const std::string& file_path,
                                                ...
                                                const char* prefix);
    [[nodiscard]] static std::optional<std::filesystem::path> detect_split_dwarf_path(const std::string& file_path);
    [[nodiscard]] static std::optional<std::filesystem::path> detect_debug_sup_path(const std::string& file_path);
    [[nodiscard]] static std::optional<std::filesystem::path> detect_gnu_debugaltlink_path(
        const std::string& file_path);
    void tie_debug_handles(Dwarf_Debug primary_debug, Dwarf_Debug secondary_debug, const char* error_prefix);
...
[[nodiscard]] std::optional<DieHandle> sibling_of(Dwarf_Debug debug, Dwarf_Die die, bool is_info);
[[nodiscard]] std::optional<AttributeHandle> attribute_of(Dwarf_Debug debug, Dwarf_Die die, Dwarf_Half attr);
...
[[nodiscard]] std::optional<DieHandle> die_from_offset(Dwarf_Debug debug, Dwarf_Off offset, bool is_info = true);
...
[[nodiscard]] std::optional<Dwarf_Addr> indexed_address_from_die_location(Dwarf_Die die,
                                                                          const LocationDescription& location);
[[nodiscard]] std::optional<LocationDescription> read_location_description(Dwarf_Debug debug,
                                                                           Dwarf_Attribute attr,
                                                                           Dwarf_Half address_size,
                                                                           Dwarf_Half offset_size,
                                                                           Dwarf_Half dwarf_version,
                                                                           DwarfByteOrder byte_order);
[[nodiscard]] std::optional<LocationDescription> read_location_expression(Dwarf_Debug debug,
                                                                          ...
                                                                          Dwarf_Half dwarf_version,
                                                                          DwarfByteOrder byte_order);
[[nodiscard]] std::optional<LocationDescription> read_range_description(Dwarf_Attribute attr,
